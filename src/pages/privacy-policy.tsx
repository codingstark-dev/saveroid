  ...
  return (
    <div >
      ...
      <Main
        meta={
          <Meta
            title="Privacy Policy | SaveRoid ⇣ - All in One Video Downloader"
            description="Privacy Policy | SaveRoid ⇣ - All in One Video Downloader"
      ...
      >
        <div className="lg:max-w-2xl mx-auto px-7 sm:max-w-lg md:max-w-lg pt-14 prose prose-red">
          <h1 className="font-light">Privacy Policy for SaveRoid </h1>

          <p>
            At SaveRoid, accessible from https://saveroid.com/, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that
            is collected and recorded by SaveRoid and how we use it.
          </p>
          ...
          <p>
            ...
            our website with regards to the information that they shared and/or collect in SaveRoid.
          ...
          <p>
            SaveRoid follows a standard procedure of using log files. These files log visitors when
          ...
          <p>
            Like any other website, SaveRoid uses 'cookies'. These cookies are used to store
          ...
          <p>
            ...
            <a href="https://www.privacypolicyonline.com/what-are-cookies/" rel="nofollow">
              "What Are Cookies"
            </a>
            .
          </p>
          ...
          <p>
            ...
            SaveRoid, which are sent directly to users' browser. They automatically receive your IP
          ...
          <p>
            Note that SaveRoid has no access to or control over these cookies that are used by
          ...
          <p>
            SaveRoid's Privacy Policy does not apply to other advertisers or websites. Thus, we are
          ...
          <p>
            SaveRoid does not knowingly collect any Personal Identifiable Information from children
